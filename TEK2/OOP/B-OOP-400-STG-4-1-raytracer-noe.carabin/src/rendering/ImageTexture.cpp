 ...
 *
 * The constructor throws `std::runtime_error` if the file cannot be
 * read or the format is unsupported.
*/
...
/**
 * @brief Sample the texture with UV coordinates.
 * @param u Horizontal coordinate in [0,1] (wraps outside).
 * @param v Vertical   coordinate in [0,1] (wraps outside).
 * @return  RGB colour in linear space, range [0,1].
*/
...
/**
 * @brief Skip PPM comment lines (starting with ‘#’) while reading.
 * @param is Input stream already positioned in the PPM header.
*/
