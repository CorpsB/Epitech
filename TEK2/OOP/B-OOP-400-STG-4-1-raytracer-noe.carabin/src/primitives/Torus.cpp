...
RayTracer::Torus::Torus(const Math::Point3D& c,
            double majorRadius,
            double minorRadius,
            const Material& mat)
        : APrimitive(mat), center(c), R(majorRadius), r(minorRadius) {}

    bool RayTracer::Torus::hits(const Ray& ray, double& tHit, HitRecord& rec) const
    {
    ...
    RayTracer::AABB RayTracer::Torus::bounds() const
    {
    ...
    double RayTracer::Torus::torusField(const Math::Vector3D& O, const Math::Vector3D& D, double t,
    ...
    bool RayTracer::Torus::intersectTorus(const Math::Vector3D& O, const Math::Vector3D& D, double R, double r,
    ...
    double RayTracer::Torus::solveCubicReal(double A, double B, double C, double D)
    {
    ...
    std::vector<double> RayTracer::Torus::solveQuadratic(double a, double b, double c)
    {
    ...
    std::vector<double> RayTracer::Torus::solveCubicAllReal(double a, double b, double c, double d)
    {
        std::vector<double> roots;
    ...
    std::vector<double> RayTracer::Torus::solveQuartic(double A, double B, double C, double D, double E)
    {
