...
lunch_test() {
    ...
    if diff -q test/tcsh_1.txt "test/42sh_1.txt" > /dev/null && diff -q test/tcsh_2.txt "test/42sh_2.txt" > /dev/null && diff -q test/tcsh_exit.txt "test/42sh_exit.txt" > /dev/null; then
        echo -e "TEST RESULT : OK"
        count+=1
    else
        echo -e "TEST RESULT : KO :("
        if diff -q test/tcsh_1.txt "test/42sh_1.txt" > /dev/null; then
            echo "---"
            echo -e "STANDAR OUTPUT : OK"
        else
            echo "---"
            echo -e "STANDAR OUTPUT : KO"
            echo ""
            echo -e "42SH STANDAR OUTPUT :"
            cat "test/42sh_1.txt"
            echo ""
            echo -e "TCSH STANDAR OUTPUT :"
            cat test/tcsh_1.txt
            echo ""
            echo -e "DIFFERENCE :"
        ...
        if diff -q test/tcsh_2.txt "test/42sh_2.txt" > /dev/null; then
            ...
            echo "---"
            echo -e "ERROR OUTPUT : KO"
            echo -e "42SH ERROR OUTPUT :"
            cat "test/42sh_2.txt"
            echo -e "TCSH ERROR OUTPUT :"
            cat test/tcsh_2.txt
            echo -e "DIFFERENCE :"
        ...
        if diff -q test/tcsh_exit.txt "test/42sh_exit.txt" > /dev/null; then
            echo "---"
            echo -e "EXIT_CODE OUTPUT : OK"
        else
            echo "---"
            echo -e "EXIT_CODE OUTPUT : KO"
            echo -e "42SH EXIT_CODE OUTPUT :"
            cat "test/42sh_exit.txt"
            echo -e "TCSH EXIT_CODE OUTPUT :"
